...
/**
 * Adapter for displaying wallpaper options.
 * 
 * @author leon_nicholls
 * 
 */
public class WallpaperGalleryImageAdapter extends ArrayAdapter<WallpaperInfo> {
	...
	public WallpaperGalleryImageAdapter(Context context, ArrayList<WallpaperInfo> wallpapers) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (gridView == null) {
			gridView = inflater.inflate(R.layout.wallpapers_item, null);
		...
		final WallpaperInfo info = getItem(position);

		holder.textView.setText(info.getTitle());

		if (info.getDrawable() != null) {
			holder.imageView.setImageDrawable(info.getDrawable());
		}
